...
4. Jalankan server Apache. Buka http://localhost/jkp.
...
Kontribusi sangat diterima! Baca [CONTRIBUTING](CONTRIBUTING.md) dan buka [Issues](https://github.com/Celieln/jkp/issues) untuk melaporkan bug / request fitur.
