...
<div class="sidebar" id="sidebar">
    ...
    <a href="tambah.php" class="nav-item active"><i class="bi bi-plus-circle"></i> Tambah Data</a>
...
<div class="card-header">
    <h4 class="fw-bold mb-0" style="color:#fff"><i class="bi bi-plus-circle me-2"></i>Tambah Data JKP</h4>
</div>
<div class="card-body">
...
<textarea name="alasan_phk" class="form-control" placeholder="Deskripsi alasan PHK" required></textarea>
</div>
</div>
...
<button class="btn-glass primary px-4"><i class="bi bi-check-lg"></i> Simpan</button>
